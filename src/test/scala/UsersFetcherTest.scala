...
//
//  case class FixtureParam(usersFetcher: UsersFetcher)
//
//  def withFixture(test: OneArgTest) = {
//
//    val defaultConfig = ConfigLoader.defaultConfig
//
//    val testS3Config = defaultConfig.s3Config.copy(usersBucketName = ConfigFactory.load().getString("s3.usersBucketName"))
//
//    val usersFetcher = new UsersFetcher(testS3Config)
//    val testFixture = FixtureParam(usersFetcher)
//
//    try {
